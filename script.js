...
new_db = [
	[	
	//30
		"It was the idea to do something like that because it just doesn't exist.",
		"Art is a value in itself, creates space and food for thought.",
		"It’s then about sustaining the conversation",
		"We use the art world as a platform to start a conversation",
		"invitation to appropriate the project and transform it.",
		"a discursive space, in the knowledge that archives are unstable and incomplete",
		"It's a language that you can use, and just jumping into that language is a very rich form.",
		"<span>a different kind of</span> <span>epistemology, that <span>reconnects us to other</span> <span>ways of knowing the</span> <span>human-nature symbiosis</span>",
		"<span>It is less about art than</span> <span>it is about being artists</span> <span>and being human again—</span> <span>and questioning what that means</span> <span>in our current context.</span>",
		"<span>it encourages the state of</span> <span>potentiality, the state of</span> <span>being pure potential.</span>",
	],[
	// 100
	    "“The material already says half of what I wanted to say. We need to let the material speak.”",
	    "“Art needs to dominate the means of production that industry dominates.” <span class='quote'>(3:40-3:45)</span>"
	],[
	// 200
	    "“I understood the message [of the forest] to be that respect and reciprocity are fundamental and universal values necessary to achieve a fulfilled and happy life.” <span class='quote'>(5:44-5:54)</span>",
	    "“I am an artist. And I decided to ground my practice in the creation of works that find their purpose in the social realm through group participation.” <span class='quote'>(2:06-2:19)</span>",
	    "“It's [the project] not strongly related to the tsunami. It's strongly related to Kitakama village.” <span class='quote'>(08:14-08:20)</span>",
	    "“We can think of the university as a healing practice for the territory, that has been injured by colonial intervention, extractivist projects, and by epistemological occupation.” <span class='quote'>(25:09-25:24)</span>",
	    "“It is not a project that happens 'over there'. It has very much to do with Western institutions of learning.” <span class='quote'>(16:11-16:20)</span>",
	    ...
	    "[article was on the Oyster Table project by Cooking Sections: included a collaboration with restaurants as well]",
	    ...
	    "“...the role of the curator in facilitating an ecology of practices between various disciplines” e.g artists, theorists, scientists Knowledge as produced under different conditions ",
	    "<span class='question-2'>TDR: Why did you name your theatre Bread & Puppet?</span>SCHUMANN: Bread means bread. Something basic. We give it out during or after the show.<span class='question-2'>TDR: Why?</span>SCHUMANN: We would like to be able to feed people.",
	    "“The traveling puppet shows range<br>from tightly composed theater<br>pieces presented by members<br>of the company to extensive<br>outdoor pageants<br>which require the<br>participation of<br>many<br>volunteers.”"
	],[
	// 300
	    "&nbsp;“When I use language,<br>I'm aware of the materiality of it.<br>It has to translate into something<br>texturally, in material - so that with the<br>mats, they're really a quite literal<br>means of interweaving the language<br>within the concept.” <span class='quote'>(1:58-2:18)</span>",
	    "“Collection remains a<br>large aspect of what I do. I mean,<br>I'm more interested in how certain things<br>get to be where they are, and the narratives behind them - so I'm interested not necessarily in the object itself,<br>but the story behind that.”  <span class='quote'>(0:08-0:26)</span>",
	    "'Handling a material<br>makes me understand its limitations<br>and its potential. So at the level of ideas I know what is feasible and what is not. Proximity to the material defines the formal aspects of the work and its tangibility. I therefore do not outsource the<br>physical aspect of art-making.' <span class='quote'>(42-3)</span>",
	    "“...I invite you to look<br>at your surroundings with<br>new eyes. Listen and learn with<br>the spirit of sharing. It's an exercise of reciprocal appreciation.<br>Let's all learn together: me from you, and<br>you from me. Just like seeds that<br>sprout, this never ends.” <span class='quote'>(16:07-16:32)</span>",
	    "Art needs to “update its<br>own techniques as fast as the<br>industry or politics in order to be able<br> to respond to all of this, to produce<br> somethingabout these social codes or<br>to say something about the<br>historical field.” <span class='quote'>(3:20-3:38)</span>",
	    "“...My relationship to<br>the ocean is one of love and care.<br>Even before being an artist, I'm an<br>indigenous landowner, and with that<br>comes an enormous respect and care -<br>but also a concern for our oceans<br>at the moment.” <span class='quote'>(1:31-1:47)</span>",
	    "“I think research<br>is collaborative, so it's<br>all these intersecting ideas of what<br>research is; how science and art come<br>together. It's this whole community of<br>experiences that will feed in, I think,<br>to my work.” <span class='quote'>(1:16- 1:33)</span>",
	    "“The name 'spiral shore'<br>also refers to the spiral of our DNA.<br>If we trace the spiral, we can encounter<br>the lives of the people before and after<br>our time. That's what I hoped to convey<br>when I titled the series Spiral Shore<br>(Rasen Kaigen).” <span class='quote'>(09:02-09:15)</span>",
	    "“Though photography is a<br>visual art, I thought that maybe photos<br>could actually portray a world we could not<br>see with the naked eye. Perhaps the spirit or<br>the history of Kitakama - something that we cannot see - the thing that brought this<br>community together, the big picture.” <span class='quote'>(1:54-2:23)</span>",
	    "“A history of women, in our<br>opinion, is first and foremost a social<br>history. We have curated this exhibition as a<br>call to contribute to the archive we have<br>started building. We seek and welcome more<br>materials that will help us achieve this mission<br>of a more inclusive history—and future<br>—of Nepal.”",
	    "<span class='question-1'>DN: What do you hope people will take away [..] from engaging or participating in the improvisational music that's happening?</span>TA: Maybe the most important thing for me is to have the feeling that we shared something we cannot speak about. A moment that is undescribable.<span class='quote'><span class='quote'>(25:00—25:21)</span></span>",
	    "2. Selain itu, sejak awal saya ingin memberikan karakter lokal dengan gerakan Pustaka Bergerak. Karena Pustaka Bergerak ini bukan hanya gerakan literasi, tapi kultural yang menonjolkan aspirasi para relawannya. Kami ingin masyarakat bangga dengan budaya lokalnya.",
	    "Kini, kembali seluruh<br>relawan diundang untuk jadi<br>seniman. Yang mengundang kali ini<br>adalah penyelenggara Istanbul Bienal, Turki. Karya relawan yang memikat bukan hanya akan dapat dinikmati oleh warga Indonesia, atau Turki saja, tapi<br>oleh seluruh dunia."
	],[
	// 400
		[
	    "<span>An</span>\
	    ...
	    "<span>“The</span>\
			...
			</span class='quote'>(7:07-7:28)</span>",
	    "<span>“The</span>\
			<span>works’</span>\
	    ...
	    "<span>&nbsp;</span>\
			...
			<span>sincretisme.<span class='quote'>(1:52-2:31)  </span></span>",
	    "<span> “[the</span>\
			<span>work]</span>\
	    ...
	    "<span>&nbsp;</span>\
			...
			<span>Barbata told Hyperallergic.’</span>",
				    "<span>“It’s</span>\
			<span>been more</span>\
			...
			<span>environment around us.”<span class='quote'>(0:34-0:57)</span></span>",
			],[
	    ...
	    "“One of the core ideas of the university as a decolonial exercise is to foreground how important it is for education to encounter the Other as mind. What indigenous knowledge intends to teach, and the Inga, in particular, is that the Other is mind. The Other is person. That we co-emerge in the relationship with the Other.” <span class='quote'>(23:07-23:32)</span>",
	    "“Puppet, mask, and performing object theatre has deep roots connecting a vast array of contemporary and ancient performance practices. The usefulness of writing about and analyzing these practices, and the theories behind them, will increase our ability to link worldwide traditions with worldwide innovations.” <span class='quote'>(20)</span>",
	    ...
	    "FULLERTON: That sounds like you’re offering a “solution.”COOKING SECTIONS: We don’t think we provide solutions because we don’t have them. Our social and political interventions question and problematize certain situations. By drawing attention to various situations we are complicating them and making people take more responsibility.",
	    "“As Fernández Pascual says: ‘We use the art world as a platform to start a conversation. But it doesn’t stay there. The goal is to mobilize a series of actions in collaboration with residents and communities that bring change.’“FULLERTON: Each buyer of your The Empire Remains Shop must sign a franchise agreement. Is this to encourage people to take an active stake in your project?",
	    ...
	    "[on putting together Waters' Witness] “...a lot of the decisions on how elements are placed and in dialogue with each and with the space came from listening to the material one by one. So, listening to each stone, listening to the rails, and seeing how these elements are transmitting and emitting sound.” <span class='quote'>(3:14-3:32)</span>",
	    "[on establishing the mechanised mangrove exhibit through a collaborative trial and error] ...it's not about this mangrove moving perfectly, it's about all of us coming together and obsessing about this machine, for months. It's about a way of thinking. If we talk about all these issues; we need to come together — it's not one person that's gonna save the world. <span class='quote'>(1:00-1:22)</span>",
	    "Masalahnya, ide nyentriknya ini tentu tidak bisa dilakukannya seorang diri. Berbagai kendala dihadapinya terutama untuk mencari mereka yang mau menggerakan kuda dan buku ini sehingga dapat mendekati pembaca di daerah pelosok Indonesia.Singkat cerita dengan memanfaatkan sosial media dan jejaring yang dimilikinya, ia pun menemukan relawan-relawan yang menjadi pionir di daerahnya masing-masing. ",
	...
	// 500
	    ...
	    "<span class='italic underline'>The indigenous scientist is the<br>ultimate radical figure</span> which has the<br>capacity of merging the contradictions;<br>of being at once scientific and a political actor, cohabiting the natural world while seeking to understand it. Most importantly, this figure stands for a <span class='italic underline'>different kind of epistemology, that reconnects us to other ways of knowing the human-nature symbiosis.</span> In other words, this figure embodies some of the most fundamental problems in our mind-nature<br>conception.” <span class='quote'>(11:57-12:31)</span>",
	...
	// 700
	    ...
	    "CaroBD: Do you have a big purpose as a puppeteer and a teacher in puppeteering, do you have something you want to achieve [...] with the medium?JB: Just letting people know that it's an option, it's a medium that can be used in many different ways. [...] When I'm teaching I'm just hoping to share with students the idea that <span class='invert_black'>anybody can do it</span> - anybody can make a puppet show. [...] You can enter into the form on many different levels, it can be satisfying if you're just an amateur or if you're just playing with a stuffed animal with your child and you make it talk. Or if you do a legitimate theatre show [...] or out on the street, it's all possible. <span class='quote'>(18:16 - 20:20)</span>",
	...
	// 2000
		...
		//img
		[['_DSC9446_fullsize.jpg']],
		[['_DSC9501_fullsize.jpg','_DSC9513_fullsize.jpg']],
		[['_DSC9522_fullsize.jpg','_DSC9518_fullsize.jpg','_DSC9525_fullsize.jpg']],
		[['_DSC9540_fullsize.jpg']],
		[['_DSC9551_fullsize.jpg','_DSC9566_fullsize.jpg']],
		[['2015-05-22_17.01.43.jpg']],
		[['20150910_091357.jpg']],
		[['20160916_104254.jpg','20160916_104256.jpg','20160916_104259.jpg']],
		[['20160919_094957.jpg','20160919_094959.jpg','20160919_095000.jpg']],
		[['20160919_095034.jpg','20160930_092128.jpg','20160930_092132.jpg']],
		[['20161006_144344.jpg','20161006_144419.jpg','20161006_144453.jpg']],
		[['Abuela_Eudocia_1.2.1.jpg']],
		[['bread.docx']],
		[['bread2.jpg','bread3.jpg']],
		[['bread4.jpg']],
		[['bread5.jpg']],
		[['bread6.jpg','bread7.jpg']],
		[['bread8.jpg']],
		[['bread9.jpg']],
		...
		[['Drone2_1.14.2.jpg']],
		[['EducationalStudies02_023_OMP3236.jpg','EducationalStudies02_047_OMP3493.jpg','EducationalStudies02_052_OMP3451.jpg']],
		[['Hernando3_1.9.1.jpg']],
		[['IB-GP2.png']],
		[['Microphones_in_shallow_waters_-_copie.jpg']],
		[['Rubiela_cu2_1.53.3.jpg','Rubiela2_2.1.1.jpg']],
		[['WR1F4C~1.jpg']],
		[['WR3AB4~1.jpg','WR9F4C~1.jpg','WR20DD~1.jpg','WR55E6~1.jpg','WR542D~1.jpg','WR860D~1.jpg','WRE480~1.jpg','WRF3E3~1.jpg']],
        ...
        for (var i = new_text_content.length - 1; i >= 0; i--) {
            for (var j = 0; j < 3; j++) {
                if(new_text_content_org[i][j].split('-')[0] == 'sep_30'){
                    ...
                    new_text_content[i][j] = new_db[0][0]
                    new_db[0].shift()
                }
                if(new_text_content_org[i][j].split('-')[0] == 'sep_100'){
                    new_text_content[i][j] = new_db[1][0]
                    new_db[1].shift()
                }
                if(new_text_content_org[i][j].split('-')[0] == 'sep_200'){
                    new_text_content[i][j] = new_db[2][0]
                    new_db[2].shift()
                }
                if(new_text_content_org[i][j].split('-')[0] == 'sep_300'){
                    new_text_content[i][j] = new_db[3][0]
                    new_db[3].shift()
                }
                if(new_text_content_org[i][j].split('-')[0] == 'sep_400'){
	                if(new_text_content_org[i][j].split('-')[1] == '2'){
	                    new_text_content[i][j] = new_db[4][0][0]
	                    new_db[4][0].shift()
	                }else{

	                    new_text_content[i][j] = new_db[4][1][0]
	                    new_db[4][1].shift()
	                }
                }
                if(new_text_content_org[i][j].split('-')[0] == 'sep_500'){
                    new_text_content[i][j] = new_db[5][0]
                    new_db[5].shift()
                }
                if(new_text_content_org[i][j].split('-')[0] == 'sep_700'){
                    new_text_content[i][j] = new_db[6][0]
                    new_db[6].shift()
                }
                if(new_text_content_org[i][j].split('-')[0] == 'sep_900'){
                    new_text_content[i][j] = new_db[7][0]
                    new_db[7].shift()
                }
                if(new_text_content_org[i][j].split('-')[0] == 'sep_1000'){
                    new_text_content[i][j] = new_db[8][0]
                    new_db[8].shift()
                }
                if(new_text_content_org[i][j].split('-')[0] == 'sep_2000'){
                    new_text_content[i][j] = new_db[9][0]
                    new_db[9].shift()
                }
                if(new_text_content_org[i][j].split('-')[0] == 'sep_img'){
                	new_text_content[i][j] = ''
                	for (var k = new_db[10][0][0].length - 1; k >= 0; k--) {
                			new_text_content[i][j] = new_text_content[i][j] + '<div class="sep_img_inner sep_img_inner_'+k+' sep_img_inner_whole_'+new_db[10][0][0].length+'" style = "background-image:url(img/ib_image_batch/'+new_db[10][0][0][k]+')"></div>'
                		// }
                	}
                    new_db[10].shift()
